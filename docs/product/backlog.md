...
- **Task 1.1** *(In progress)*: Refine Epic 1 into user stories (product-spec Next step; `/sdlc-user-story-refiner` or equivalent). *(Evidence: 2026-09-20 — US-E1-01 through US-E1-07 exist under `docs/product/user-stories/epic-1/`, plus `docs/product/user-stories/README.md` (merged PR #5). **US-E1-01** and **US-E1-02** approved by **mjbvilhena** (2026-09-20, named human sign-off of the story artefacts); stakeholder-acceptance checkboxes marked for those artefacts only, not implementation Done. **US-E1-03 through US-E1-07** remain drafted; no named human approval of those stories; their stakeholder-acceptance checkboxes remain unchecked. Task 1.1 is not Done until all Epic 1 stories are approved. Drafted or merged story files are not approval. No Epic 2–4 story folders.)*
