...
**Backlog:** Task 1.1 *(In progress)* — US-E1-01 through US-E1-06 approved by **mjbvilhena** (2026-09-20, named human sign-off); US-E1-07 remains drafted, awaiting named human approval. Drafted or merged files are not approval. Task 1.1 is not Done until US-E1-07 is approved. Task 1.2 *(Not done)* until the outcome ships in an application
...
| US-E1-05 | [`us-e1-05-preference-scoring.md`](us-e1-05-preference-scoring.md) | Capture the 1–5 scoring matrix (simultaneous web widget + CLI TUI) | Approved by **mjbvilhena** (2026-09-20). Not Done as shipped software. |
| US-E1-06 | [`us-e1-06-any-destination.md`](us-e1-06-any-destination.md) | Any destination the tools can reach | Approved by **mjbvilhena** (2026-09-20). Not Done as shipped software. |
