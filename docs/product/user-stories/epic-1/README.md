...
**Backlog:** Task 1.1 *(In progress)* — US-E1-01 approved by **mjbvilhena** (2026-09-20, named human sign-off); US-E1-02 through US-E1-07 remain drafted, awaiting named human approval. Drafted or merged files are not approval. Task 1.1 is not Done until all Epic 1 stories are approved. Task 1.2 *(Not done)* until the outcome ships in an application
...
| --- | --- | --- | --- |
| US-E1-01 | [`us-e1-01-signed-in-account.md`](us-e1-01-signed-in-account.md) | Signed-in consumer account (Google sign-in in scope) | Approved by **mjbvilhena** (2026-09-20). Not Done as shipped software. |
| US-E1-02 | [`us-e1-02-submit-trip-prompt.md`](us-e1-02-submit-trip-prompt.md) | Submit a chat-like trip prompt | Drafted — awaiting named human approval |
| US-E1-03 | [`us-e1-03-structured-constraints.md`](us-e1-03-structured-constraints.md) | Structured constraints for the Supervisor | Drafted — awaiting named human approval |
| US-E1-04 | [`us-e1-04-party-size-required.md`](us-e1-04-party-size-required.md) | Ask when party size is missing | Drafted — awaiting named human approval |
